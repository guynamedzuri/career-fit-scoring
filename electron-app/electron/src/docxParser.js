...
exports.extractTablesFromDocx = extractTablesFromDocx;
exports.getCellValue = getCellValue;
exports.findRowByText = findRowByText;
exports.findColumnByText = findColumnByText;
/**
 ...
 */
function getCellValue(tables, tableIndex, rowIndex, cellIndex) {
 ...
 */
function findRowByText(tables, tableIndex, searchText, searchCellIndex = 0) {
    if (tableIndex < 0 || tableIndex >= tables.length) {
        return -1;
    }
    const table = tables[tableIndex];
 ...
 */
function findColumnByText(tables, tableIndex, searchText, searchRowIndex = 0) {
    if (tableIndex < 0 || tableIndex >= tables.length) {
        return -1;
    }
    const table = tables[tableIndex];
